  ...
  return (
    <Link href={`/themes/${theme.id}`} className="th-card">
      <div className="th-head">
        ...
        <div className="th-evts"><FocusLevelBadge strength={theme.theme_strength_score} stage={theme.playbook_stage} typicalDurationDaysUpper={pb?.typical_duration_days_approx?.[1]} /></div>
      </div>
